...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet(u"border-image: url(:images/dark_background.png) 0 0 0 0 stretch stretch;")
...
"")
        icon = QIcon()
        icon.addFile(u"../qt_images/play_button_left.png", QSize(), QIcon.Normal, QIcon.Off)
